...
def clean_phone_number(phone_raw):
    ...
    Removes dashes, spaces, brackets. Ensures country code (defaults to India +91 if missing).
    """
...
if df_candidates.empty:
    ...
    # --- MODE 2: SEND SURVEY (WHATSAPP & EMAIL) ---
        ...
        display_cols = ['First Name', 'Last Name', 'Phone Number', 'Email']
        ...
        if event.selection.rows:
            ...
            cand_phone = selected_row.get('Phone Number', '')
