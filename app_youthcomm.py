...
def load_candidates(sheet_name):
    ...
    if url:
        ...
        if data:
            ...
            # --- BUG FIX: Clean column names and drop duplicates ---
            # This prevents Pandas from returning a DataFrame when we ask for a single column
...
if df_candidates.empty:
    ...
    if df_display.empty:
        ...
        # --- BUG FIX: Safer label generation ---
        def make_label(row):
